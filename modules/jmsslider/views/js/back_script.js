...
$(document).ready(function () {
	...
	$('#quick-check').click(function() {
		url = $('#site_url').val() + 'modules/jmsslider/ajax_jmsslider.php?action=quickEdit';
	...
	$('#form_add_layer').on('submit', function (e) {
		...
		url = $('#site_url').val() + 'modules/jmsslider/ajax_jmsslider.php?action='+action+'&data_type=image&id_slide=' + id_slide;
	...
	$('.quick-delete').click(function() {
	 ...
	 function duplicateLayer() {
		url = $('#site_url').val() + 'modules/jmsslider/ajax_jmsslider.php?action=duplicateLayer';
		id_layer = $('#id_layer').val();
		$.ajax({
			type : "POST",
			url : url,
