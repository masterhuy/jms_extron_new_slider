...
<div id="form_layer_{$layer->id}" class="form-layer panel-bodyclearfix" style="display:none">
    ...
    <div class="area-displgontay form-horizontal">
        <div class="layerconfig layer-col">
            <div class="inner">
                <div class="tab">
                    <button type="button" class="tablinks defaultOpen" onclick="openCity(this, 'tab_setting_{$layer->id}')">{l s='Layer Setting' d='jmsslider'}</button>
                    <button type="button" class="tablinks tab-desktop" onclick="openCity(this, 'tab_style_{$layer->id}')">{l s='Style' d='jmsslider'}</button>
                    <button type="button" class="tablinks tab-desktop" onclick="openCity(this, 'tab_position_{$layer->id}')">{l s='Position' d='jmsslider'}</button>
                    <button type="button" class="tablinks" onclick="openCity(this, 'tab_animation_{$layer->id}')">{l s='Animation' d='jmsslider'}</button>
                    {if $layer->data_type == 'video'}
                    <button type="button" class="tablinks video-settings" onclick="openCity(this, 'tab_video_set_{$layer->id}')">{l s='Video Setting' d='jmsslider'}</button>
                    {/if}
                    <button type="button" class="tablinks tab-mobile" onclick="openCity(this, 'tab_style_mobile_{$layer->id}')">{l s='Style Mobile (< 480)' d='jmsslider'}</button>
                    <button type="button" class="tablinks tab-mobile2" onclick="openCity(this, 'tab_style_mobile2_{$layer->id}')">{l s='Style Mobile (< 768)' d='jmsslider'}</button>
                    <button type="button" class="tablinks tab-tablet" onclick="openCity(this, 'tab_style_tablet_{$layer->id}')">{l s='Style Tablet (< 1200)' d='jmsslider'}</button>
                </div>
                <div id="tab_setting_{$layer->id}" class="tabcontent">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-3">
                            <label class="control-label col-lg-3">{l s='Class suffix' d='Modules.JmsSlider'}</label>
                            <div class="col-lg-9">
                                <input type="text" name="data_class_suffix_{$layer->id nofilter}" value="{$layer->data_class_suffix nofilter}">
                            </div>
                        </div>
                        <div class="form-group col-lg-3">
                            <label class="control-label col-lg-3">{l s='Layer fixed' d='Modules.JmsSlider'}</label>
                            <div class="col-lg-4">
                    ...
                    <div class="row" style="display:none">
                        <div class="form-group col-lg-9">
                            <label class="control-label col-lg-1">{l s='Text' d='Modules.JmsSlider'}</label>
                            <div class="col-lg-9">
                ...
                <div id="tab_video_set_{$layer->id}" class="tabcontent">
                    ...
                    <div class="form-group">
                        <div class="col-lg-10">
                            ...
                            <label for="data_video_bg_{$layer->id nofilter}">{l s='Set this video for slide background' d='Modules.JmsSlider'}</label>
                        </div>
                    </div>
                </div>
                {/if}
